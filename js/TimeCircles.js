...
(function($) {
    ...
    TC_Instance.prototype.start = function() {
        ...
        // Check if this is an unpause of a timer
            ...
            if (typeof attr_data_timer === "number") {
				...
				console.log("set date timer", attr_data_timer);
            }
            else {
    ...
    TC_Instance.prototype.restart2 = function(value) {
		this.data.timer = false;
        this.start();
		this.data.attributes.ref_date = value;
	}
    ...
    TC_Class.prototype.restart2 = function(value) {
	   this.foreach(function(instance) {
            instance.restart2(value);
        });
        return this;
	};
